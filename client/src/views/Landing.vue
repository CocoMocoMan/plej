      ...
      <div class="container">
        ...
        <div class="columns">
          ...
          <div class="column">
            <div class="card-text">
              <p
                class="subtitle is-5 is-muted has-text-left pt-2"
              >Plej is a community powered donation service that provides a direct connection between</p>
              <p
                class="subtitle is-5 is-muted has-text-left"
              >the creator and their audience. With our no strings attached model of donating, giving</p>
              <p
                class="subtitle is-5 is-muted has-text-left"
              >support to your favorite artist's individual content is made simple and easy. At Plej our</p>
              <p
                class="subtitle is-5 is-muted has-text-left"
              >focus is to supply the necessary tools to succeed and thrive for all partnered creatives, big</p>
              <p
                class="subtitle is-5 is-muted has-text-left"
              >and small. We also work to create an avenue for the voices of their fandoms to be heard</p>
              <p
                class="subtitle is-5 is-muted has-text-left"
              >and acknowledged. Our mission is to lift up artists and give power back to the people that</p>
              <p
                class="subtitle is-5 is-muted has-text-left"
              >deserve it by providing the ability for creators to achieve financial independence and</p>
              <p
                class="subtitle is-5 is-muted has-text-left"
              >realize their true vision in its purest form. We understand the importance of creative</p>
              <p
                class="subtitle is-5 is-muted has-text-left"
              >freedom and individual expression. Let's shape the internet and drive great content,</p>
