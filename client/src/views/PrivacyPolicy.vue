<template>
  <div class="columns">
    <div class="column is-4">
      <affix relative-element-selector="#content" :offset="{ top: 40, bottom: -285 }">
        ...
        <ul class="ml-6 pl-6 pb-6 mb-6">
          ...
          <br />
          <li>
            <a href="#DataCollection">Collecting and Using Your Personal Data</a>
          </li>
          <br />
          <li>
            <a href="#Tracking">Tracking Technologies and Cookies</a>
          </li>
          <br />
          <li>
            <a href="#Retention">Retention of Your Personal Data</a>
          </li>
          <br />
          <li>
            <a href="#Transfer">Transfer of Your Personal Data</a>
          </li>
          <br />
          <li>
            <a href="#Transactions">Business Transactions</a>
          </li>
          <br />
          <li>
          ...
          <br />
          <li>
            <a href="#Security">Security of Your Personal Data</a>
          </li>
          <br />
          <li>
            <a href="#CAPrivacyRights">California Privacy Rights</a>
          </li>
          <br />
          <li>
    ...
    <div class="column is-6" id="content">
      ...
      <br />
      <a id="Preface"></a>
      <h1 class="is-size-5 is-strong">Preface</h1>
      <br />
      <p>This Privacy Policy describes Our policies and procedures on the collection, use and disclosure of Your information when You use the Service and tells You about Your privacy rights and how the law protects You.</p>
      <p>We use Your Personal data to provide and improve the Service. By using the Service, You agree to the collection and use of information in accordance with this Privacy Policy.</p>
      <br />
      <a id="Interpretation"></a>
      <h1 class="is-size-5 is-strong">Interpretation and Definitions</h1>
      <br />
      <h2 class="is-size-5 is-strong">Interpretation</h2>
      <p>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to Plej Inc., 13348 Old Winemaster Ct.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Plej.link, accessible from
            <a
              href="https://plej.link"
        ...
        <li>
          <p>
            <strong>Billing for Donations</strong>, as a donator you must provide your payment information to our payment processors. You can see the privacy policy for these payment processors on the PayPal and Stripe sites. At this time, Plej does not receive your full card number. Payment processors provide us with a token that represents your account, your card’s expiration date, card type and the last four digits of your card number. If you are required to provide your name and email address to the payment processor, then they also provide us with that information.
          </p>
        </li>
      </ul>
      <br />
      <a id="DataCollection"></a>
      <h1 class="is-size-4 is-strong">Collecting and Using Your Personal Data</h1>
      <br />
      <h2 class="is-size-5 is-strong">Types of Data Collected</h2>
      <br />
      <h3 class="is-size-6 is-strong">Personal Data</h3>
      <br />
      ...
      <ul>
        ...
        <li>
          <p>Billing for Donations</p>
        </li>
      </ul>
      <br />
      <h3 class="is-size-6 is-strong">Usage Data</h3>
      <br />
      ...
      <br />
      <a id="Tracking"></a>
      <h3 class="is-size-5 is-strong">Tracking Technologies and Cookies</h3>
      <br />
      ...
      <br />
      <a id="Retention"></a>
      <h2 class="is-size-5 is-strong">Retention of Your Personal Data</h2>
      <br />
      ...
      <br />
      <a id="Transfer"></a>
      <h2 class="is-size-5 is-strong">Transfer of Your Personal Data</h2>
      <br />
      ...
      <br />
      <h2 class="is-size-5 is-strong">Disclosure of Your Personal Data</h2>
      <br />
      <a id="Transactions"></a>
      <h3 class="is-size-5 is-strong">Business Transactions</h3>
      <br />
      <p>If the Company is involved in a merger, acquisition or asset sale, Your Personal Data may be transferred. We will provide notice before Your Personal Data is transferred and becomes subject to a different Privacy Policy.</p>
      <br />
      <a id="LawEnforcement"></a>
      <h3 class="is-size-5 is-strong">Law Enforcement</h3>
      <br />
      <p>Under certain circumstances, the Company may be required to disclose Your Personal Data if required to do so by law or in response to valid requests by public authorities (e.g. a court or a government agency).</p>
      <br />
      <h3 class="is-size-5 is-strong">Other legal requirements</h3>
      <br />
      ...
      <br />
      <a id="Security"></a>
      <h2 class="is-size-5 is-strong">Security of Your Personal Data</h2>
      <br />
      ...
      <br />
      <a id="CAPrivacyRights"></a>
      <h1
        class="is-size-5 is-strong"
      >California Privacy Rights for Minor Users (California Business and Professions Code Section 22581)</h1>
      <br />
      ...
      <br />
      <a id="Links"></a>
      <h1 class="is-size-5 is-strong">Links to Other Websites</h1>
      <br />
      <p>Our Service may contain links to other websites that are not operated by Us. If You click on a third party link, You will be directed to that third party's site. We strongly advise You to review the Privacy Policy of every site You visit.</p>
      <p>We have no control over and assume no responsibility for the content, privacy policies or practices of any third party sites or services.</p>
      <br />
      <a id="Changes"></a>
      <h1 class="is-size-5 is-strong">Changes to this Privacy Policy</h1>
      <br />
      ...
      <br />
      <a id="Contact"></a>
      <h1 class="is-size-5 is-strong">Contact Us</h1>
      <br />
      <p>If you have any questions about this Privacy Policy, You can contact us:</p>
      <ul>
        <li>
          By visiting this
          <a href="/landing#contact_us" target="_blank">
            <u>link</u>
          </a>.
        </li>
      </ul>
